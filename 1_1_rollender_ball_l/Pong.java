...
public class Pong extends JPanel implements Runnable, KeyListener {
    ...
    private void initGame() {
        ...
        spielball = new Ball(400, 300, 20, 20);
        b1 = new Bumper(40, 225, 25, 75); //
        b2 = new Bumper(730, 225, 25, 75); //
        bonus1 = new Bonus((int) ((Math.random() * 400) + 160), (int) ((Math.random() * 300) + 120), 25, 25);
    }
    ...
    public void run() {
        while (myFrame.isVisible()) {
            ...
            if (spielball.getXKoord() > 800 - spielball.getWidth()) {
                spielball.newSpawn();
                spielball.aendereXRichtung();
                counterL++;
            }

            if (spielball.getYKoord() < 30 || spielball.getYKoord() > 577 - spielball.getWidth()) { // Wenn der Spielball an die Seitenlinien kommt, wird die y Richtung verändert
                spielball.aendereYRichtung();
            }

            if (bonus1.getRoundRect().intersects(spielball.getRect())) {
    ...
    public void paintComponent(Graphics g) {
        ...
        g.drawRoundRect(bonus1.getXKoord(), bonus1.getYKoord(), bonus1.getWidth(), bonus1.getHeight(), bonus1.getArcw(), bonus1.getArch());
        g.fillRoundRect(bonus1.getXKoord(), bonus1.getYKoord(), bonus1.getWidth(), bonus1.getHeight(), bonus1.getArcw(), bonus1.getArch());
        ...
        g.fillOval(spielball.getXKoord(), spielball.getYKoord(), spielball.getWidth(), spielball.getHeight()); // Ausfüllen des Kreises, falls die Balltextur nicht gefunden wird
